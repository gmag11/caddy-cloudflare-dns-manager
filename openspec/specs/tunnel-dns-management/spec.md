# tunnel-dns-management Specification

## Purpose

Defines how the plugin manages DNS for Cloudflare Tunnel-backed hosts: the `tunnel` directive, CNAME reconciliation and ownership, migration from and reversion to address records, and prune interaction.
